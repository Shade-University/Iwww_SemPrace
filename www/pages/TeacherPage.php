...
if ($_GET['editSchedule'] && $_GET['expell']) {
...
<div class="overview-page admin-page">
    ...
    <div class="modal-window <?php if ($_GET['editSchedule']) echo 'show'; ?>" data-modal="view-students">
        ...
        <div class="modal-box modal-students">
            <div class="inner-modal">
                ...
                <a href="?page=TeacherPage&view=<?php echo $_GET['view'] . '&deleteSchedule=' . $editSchedule['id']?>" class="expell"
                   data-modal-anchor="remove-schedule">Remove schedule</a>

                <?php $controller->createStudentsListForSchedule($editSchedule['id']);
                if($_GET['student'] && $_GET['editSchedule']) {
    ...
    <div class="modal-window <? if ($_GET['addSchedule']) echo 'show' ?> " data-modal="create-schedule">
        <div class="layer-hide"></div>
        <div class="modal-box edit-add">
            <p>Create schedule</p>
